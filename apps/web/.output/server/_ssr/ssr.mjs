...
import { d as FastURL, l as NodeResponse } from "../_libs/h3+rou3+srvx.mjs";
import { g as require_react, h as require_jsx_runtime, n as defineHandlerCallback, o as RouterProvider, t as renderRouterToStream } from "../_libs/@tanstack/react-router+[...].mjs";
import { AsyncLocalStorage } from "node:async_hooks";
//#region node_modules/.nitro/vite/services/ssr/index.js
var ssr_exports = /* @__PURE__ */ __exportAll({ default: () => startEntry });
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DBNmJO4A.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CPeOJWfG.mjs").then((n) => n.t),
		import("./start-t_jt-LgQ.mjs"),
		import("./empty-plugin-adapters-Cqc8N73O.mjs")
	]);
	return {
		routerEntry,
		startEntry,
...
var startEntry = createServerEntry({ fetch: createStartHandler(defaultStreamHandler) });
//#endregion
export { startEntry as default, ssr_exports as t };
